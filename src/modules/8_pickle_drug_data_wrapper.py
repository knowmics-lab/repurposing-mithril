...
for i in range(cores):
    ...
    subprocess.Popen(['python','8_pickle_drug_data.py',str(i1), str(i2)])

subprocess.Popen(['python','8_pickle_drug_data.py',str(len(drugs_list)-chunk_size),str(len(drugs_list))])
